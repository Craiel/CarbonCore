namespace CarbonCore.Tests.Compat.Utils
{
    ...
    public class AssemblyTests
    {
        ...
        public void RuntimeInfoTests()
        {
            ...
            Assert.IsTrue(string.Equals("CarbonCore.Utils.dll", RuntimeInfo.AssemblyName, StringComparison.OrdinalIgnoreCase), "In test environment we should be at utils runtime info");
        }
