namespace CarbonCore.CrystalBuild.Sharp.Logic
{
    ...
    public class CrystalBuildContext
    {
        ...
        public CrystalBuildContext()
        {
            ...
            this.TTSources = new List<CarbonFile>();
        ...
        public IList<CarbonFile> TTSources { get; }
        ...
        // Private
        // -------------------------------------------------------------------
        private void AddTTSource(CarbonFile ttScript)
        {
            if (this.TTSources.Contains(ttScript))
            {
                Diagnostic.Warning("Skipping Duplicate TT Source: {0}", ttScript);
                return;
            }

            this.TTSources.Add(ttScript);
        }
